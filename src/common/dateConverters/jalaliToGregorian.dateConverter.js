export default function jalaliToGregorian(jalaliYear = 1400, jalaliMonth, jalaliDay) {
	...
	sal_a = [
		0,
		31,
		(yearInGregorian % 4 === 0 && yearInGregorian % 100 !== 0) || yearInGregorian % 400 === 0 ? 29 : 28,
		31,
		30,
		31,
		30,
	...
	for (monthInGregorian = 0; monthInGregorian < 13 && dayInGregorian > sal_a[monthInGregorian]; monthInGregorian++)
		dayInGregorian -= sal_a[monthInGregorian];
